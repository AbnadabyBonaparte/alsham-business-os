...
| **Módulo 4 — Relacionamentos** (`@alsham/crm` + `0009_crm.sql`) | ✅ **CONSTRUÍDO na Etapa 11** — **arquivo, ainda não aplicado**. Aplicar é ato do dono (runbook §9). O 4º cartão da Store ([MODULO-CRM-SPEC](MODULO-CRM-SPEC.md)) |
