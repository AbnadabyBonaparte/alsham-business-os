...
- ⚠️ **A lacuna `0015`/`0016` é proposital** e vem da main. Com a Onda Dezessete (`0085`), a próxima numeração livre é **`0086`**.
...
supabase/migrations/   0001_core … 0014_ap_apply_recon_match
                       ...
                       0085_fiscalcert                    — Onda Dezessete (Fase 2 —
                                                            ...
                                                            apply do dono
                       (lacuna 0015–0016 proposital; próxima livre: 0086)
