...
- ⚠️ **A lacuna `0015`/`0016` é proposital** e vem da main. Com a Onda Onze (`0063`–`0067`), a próxima numeração livre é **`0068`**.
...
supabase/migrations/   0001_core … 0014_ap_apply_recon_match
                       ...
                       (lacuna 0015–0016 proposital; próxima livre: 0068)
