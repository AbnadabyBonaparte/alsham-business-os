...
- ⚠️ **A lacuna `0015`/`0016` é proposital** e vem da main. Com a Onda Doze (`0068`–`0072`), a próxima numeração livre é **`0073`**.
...
supabase/migrations/   0001_core … 0014_ap_apply_recon_match
                       ...
                       (lacuna 0015–0016 proposital; próxima livre: 0073)
