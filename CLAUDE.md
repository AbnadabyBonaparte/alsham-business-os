...
- ⚠️ **A lacuna `0015`/`0016` é proposital** e vem da main. Com a Onda Dezesseis (`0083`–`0084`), a próxima numeração livre é **`0085`**.
...
supabase/migrations/   0001_core … 0014_ap_apply_recon_match
                       ...
                       (lacuna 0015–0016 proposital; próxima livre: 0085)
