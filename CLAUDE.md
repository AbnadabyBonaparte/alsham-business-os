...
- ⚠️ **A lacuna `0015`/`0016` é proposital** e vem da main. Com a Onda Dezoito (`0086`–`0089`), a próxima numeração livre é **`0090`**.
...
supabase/migrations/   0001_core … 0014_ap_apply_recon_match
                       ...
                       (lacuna 0015–0016 proposital; próxima livre: 0090)
