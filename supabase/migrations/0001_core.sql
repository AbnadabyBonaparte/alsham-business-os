...
-- =============================================================================
--
-- ESTE ARQUIVO NÃO FOI APLICADO. Nenhum projeto Supabase foi criado, nenhuma
-- migration foi executada, nenhum segredo existe neste repositório. Aplicar é
-- ato do dono, depois da revisão deste PR.
--
...
--      ou DELETE, um trigger bloqueia as duas operações — inclusive para o
--      `service_role`, que passaria por cima da RLS.
--
-- =============================================================================
...
begin
  raise exception
    'core.audit_log é append-only: % bloqueado. Corrigir um erro é escrever uma nova entrada.',
    tg_op;
end;
$$;
