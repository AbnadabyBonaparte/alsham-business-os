...
/**
 * Shopping Centers · Locação — a tela detalhada é a PRÓXIMA FRENTE.
 *
  ...
  return (
    <>
      <PageHero
        ...
        subtitle="Camada comercial sobre o contrato (ctr), por id solto; o relatório de vendas é ato imutável. O módulo lease já vive no banco e no motor @alsham/lease."
      />
      <EmptyState
