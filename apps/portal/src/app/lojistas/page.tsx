...
/**
 * Shopping Centers · Lojistas — a tela detalhada é a PRÓXIMA FRENTE.
 *
  ...
  return (
    <>
      <PageHero
        ...
        subtitle="Segmento texto livre e a unidade física por id solto ao spc; o lojista volta do arquivo. O módulo mall já vive no banco e no motor @alsham/mall."
      />
      <EmptyState
