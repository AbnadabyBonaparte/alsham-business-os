...
/**
 * Shopping Centers · Fundo de Promoção — a tela detalhada é a PRÓXIMA FRENTE.
 *
 ...
 */
export default function FundoPromocaoPage() {
  return (
    <>
      <PageHero
        eyebrow="Shopping Centers · Fundo de Promoção"
        title="O caixa coletivo do shopping."
        accent="Instalado — a tela detalhada é a próxima frente."
        subtitle="Contribuições e gastos em livro imutável; o saldo nunca fica negativo. O módulo fund já vive no banco e no motor @alsham/fund."
      />
      <EmptyState
